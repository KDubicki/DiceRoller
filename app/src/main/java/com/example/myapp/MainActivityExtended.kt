...
import com.example.myapp.databinding.ActivityMainExtendedBinding
...
class MainActivityExtended : AppCompatActivity() {
    ...
    private fun updateTextAndImages() {
        ...
        rolledText.append("\nSum: $sum")
        binding.rollResultText.text = rolledText
    }
    ...
    private fun startSettingsActivity() {
        val intent: Intent = Intent(this,MainActivitySettingsActivity::class.java).apply{
    ...
    private val launchSettingsActivity =
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            ...
            if (result.resultCode == RESULT_OK) {
                ...
                make(
                    binding.root,
                    "Current settings:$numDice,isHoldEnabled: $isHoldEnabled",
                    LENGTH_SHORT
                ).show()
